...
const oneMissingNumber = (arr) => {
  ...
  return sorted.filter((num, i) => sorted[i + 1] - num > 1).map((a) => a + 1);
};
...
const set1 = [20, 18];
const set2 = [1115, 1119, 1114, 1112, 1121, 1113, 1118, 1116, 1120];
const set3 = [
  93,
  95,
  101,
